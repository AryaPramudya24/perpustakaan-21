...
<body class="host_version">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbars-host">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="about.html">Anggota</a></li>
                        <li class="nav-item"><a class="nav-link" href="about.html">Admin</a></li>
                    </ul>
    ...
    <div class="all-title-box">
        <div class="container text-center">
            <h1>Aplikasi Perpustakaan Pontianak<span class="m_1"></span></h1>
        </div>
    </div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">"Percayakan komputer Anda pada layanan profesional kami di Pontianak. Solusi cepat
                        dan terpercaya untuk semua masalah teknis!"</p>
                </div>
            </div><!-- end title -->
